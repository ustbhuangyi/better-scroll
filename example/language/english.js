export default {
  ...
  features: {
    ...
    application: {
      title: 'Rich Features',
      desc: 'It supports lots of features which can be applied in normal scroll list, picker, slide, index list, start guidance, etc. What\'s more, some complicated needs like pull down refresh and pull up load can be implemented a lot easier.'
    },
    dependence: {
